...
import IconComponents from './common/Layout/common/IconComponents';
  ...
  return (
    <Grid item xs={4} textAlign={'center'}>
      ...
      <Typography
        ...
        sx={{ color: color, fontSize: { xs: '.8rem', sm: '1rem', md: '1.3' }, wordBreak: 'break-word' }}
      >
              ...
              {visibleRows.map((transaction, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align='left' sx={{ display: 'flax', alignItems: 'center' }}>
